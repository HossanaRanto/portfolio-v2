...
-- Note: Storage buckets cannot be easily created via SQL migrations in all Supabase environments due to permissions.
-- It is recommended to create the 'projects' bucket manually in the dashboard or via a separate script.
